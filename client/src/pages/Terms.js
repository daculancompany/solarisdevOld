...
const Terms = () => {
  return (
    <div>
          ...
          <div className="col-md-12">
            <div className="servicesheader">
              ...
              <div className="contactsubheader">
                Let's set some ground rules and expectations.<br /><br />
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="col-md-8 legal">
      <h3><strong>TERMS OF SERVICE</strong></h3><br />
      <div className="update">
Last updated: December 10, 2019<br /><br /><br />
</div>


<p>Please read these Terms of Service ("Terms", "Terms of Service") carefully before using the https://www.solarisdev.co website (the "Service") operated by Solaris Equity Holdings, LLC ("us", "we", or "our").</p>
...
<strong>Availability, Errors and Inaccuracies</strong><br /><br />
...
<strong>Contests, Sweepstakes and Promotions</strong><br /><br />
...
<p>Solaris Equity Holdings, LLC has the right but not the obligation to monitor and edit all Content provided by users.</p>

<p>In addition, Content found on or through this Service are the property of Solaris Equity Holdings, LLC or used with permission. You may not distribute, modify, transmit, reuse, download, repost, copy, or use said Content, whether in whole or in part, for commercial purposes or for personal gain, without express advance written permission from us.</p>
...
<strong>Copyright Policy</strong><br /><br />
...
<p>If you are a copyright owner, or authorized on behalf of one, and you believe that the copyrighted work has been copied in a way that constitutes copyright infringement, please submit your claim via email to team@solaris-dev.com, with the subject line: "Copyright Infringement" and include in your claim a detailed description of the alleged Infringement as detailed below, under "DMCA Notice and Procedure for Copyright Infringement Claims"</p>
...
<strong>DMCA Notice and Procedure for Copyright Infringement Claims</strong><br /><br />
...
<p>You can contact our Copyright Agent via email at team@solaris-dev.com</p>

<strong>Intellectual Property</strong><br /><br />

<p>The Service and its original content (excluding Content provided by users), features and functionality are and will remain the exclusive property of Solaris Equity Holdings, LLC and its licensors. The Service is protected by copyright, trademark, and other laws of both the United States and foreign countries. Our trademarks and trade dress may not be used in connection with any product or service without the prior written consent of Solaris Equity Holdings, LLC</p>

<strong>Links To Other Web Sites</strong><br /><br />

<p>Our Service may contain links to third party web sites or services that are not owned or controlled by Solaris Equity Holdings, LLC</p>

<p>Solaris Equity Holdings, LLC has no control over, and assumes no responsibility for the content, privacy policies, or practices of any third party web sites or services. We do not warrant the offerings of any of these entities/individuals or their websites.</p>

<p>You acknowledge and agree that Solaris Equity Holdings, LLC shall not be responsible or liable, directly or indirectly, for any damage or loss caused or alleged to be caused by or in connection with use of or reliance on any such content, goods or services available on or through any such third party web sites or services.</p>
