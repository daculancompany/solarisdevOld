    ...
    <div>
      <div className="container">
        ...
        <div className="row">
          ...
          <center>Last updated: June 7, 2015</center>
          </div>
          
          
          
<p>Solaris Equity Holdings, LLC ("us", "we", or "our") operates the https://www.solarisdev.co website (the "Service").</p>

          <p>This page informs you of our policies regarding the collection, use and disclosure of Personal Information when you use our Service.</p>

          <p>We will not use or share your information with anyone except as described in this Privacy Policy.</p>

          <p><strong>We use your Personal Information for providing and improving the Service. By using the Service, you agree to the collection and use of information in accordance with this policy. </strong>Unless otherwise defined in this Privacy Policy, terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, accessible at https://www.solarisdev.co</p>
...
<p>Cookies are files with a small amount of data, which may include an anonymous unique identifier. Cookies are sent to your browser from a web site and transferred to your device. We use cookies to collect information in order to improve our services for you.</p>
          ...
          <strong>Behavioral Remarketing</strong><br /><br />
          
<p>Solaris Equity Holdings, LLC uses remarketing services to advertise on third party web sites to you after you visited our Service. We, and our third party vendors, use cookies to inform, optimize and serve ads based on your past visits to our Service.</p>

          <ul>
            <li> <strong>Google</strong><br /><br />
            ...
            <li> <strong>Perfect Audience</strong><br /><br />

              <p>Perfect Audience remarketing service is provided by NowSpots Inc.</p>

              <p>You can opt-out of Perfect Audience remarketing by visiting these pages: Platform Opt-out and Partner Opt-out.</p>

              <p>For more information on the privacy practices of Perfect Audience, please visit the Perfect Audience Privacy Policy & Opt-out web page.</p><br />
            </li>
          </ul>
          <strong>Do Not Track Disclosure</strong><br /><br />
...
<strong>Compliance With Laws</strong><br /><br />
...
<strong>Business Transaction</strong><br /><br />
          
<p>If Solaris Equity Holdings, LLC is involved in a merger, acquisition or asset sale, your Personal Information may be transferred as a business asset. In such cases, we will provide notice before your Personal Information is transferred and/or becomes subject to a different Privacy Policy.</p>
...
<p>The security of your Personal Information is important to us, and we strive to implement and maintain reasonable, commercially acceptable security procedures and practices appropriate to the nature of the information we store, in order to protect it from unauthorized access, destruction, use, modification, or disclosure.</p>
          ...
          <strong>International Transfer</strong><br /><br />
...
<p>This Privacy Policy is effective as of June 5, 2015 and will remain in effect except with respect to any changes in its provisions in the future, which will be in effect immediately after being posted on this page.</p>
